...
describe(`${program.title}`, function () {
  ...
  it('Function yolo with mysterious parameter should return a list of messages', function () {
    ...
    const whereIsMyMind = [{ sex: 9, name: "Number six" }, { sex: 9, name: "Number height" }, { sex: 2, name: "Kara" },
    { sex: 2, name: "Laura" }, { sex: 3, name: "toto" }, { sex: 1, name: "William" },
    { sex: 1, name: "Gaius" }, { sex: 1, name: "Lee" }];
